...
`redis-compressed` is a Redis module that adds `COMPRESSED.JSON.GET`, a read-only command that wraps `JSON.GET` and returns a Brotli-compressed version of the data.
